...
INSERT INTO users (id, email, password_hash, display_name, avatar, bio, school, major, company, position, phone, twitter_url, github_url, website_url, looking_for, total_hackathon_count, total_work_count, total_award_count, badge_count, certification_count, created_at, updated_at, is_banned) VALUES
  ('u1', 'alice@example.com', '$2b$10$p7ziAj3VAxgdCKyUbgIfyOQn95BcaM.ySX8qIAxjmvUgxsgOK3udq', 'ALICE_CHAIN', NULL, 'Smart contract engineer by day. AI hardware hacker by night.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '["COFOUNDER","HACKATHON_TEAMMATE"]'::jsonb, 3, 2, 1, 5, 2, '2026-04-07 17:21:58', '2026-04-08 09:40:36', 0),
  ('u_1775630509451_k18ngjsga', 'charleschen01@foxmail.com', '$2b$10$seifGZPXGsbJx9Ayw2Xsy.y.dvHxKAyFfi4qCAWcVXf9ZACFujNuK', '毕之爱吃鱼', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]'::jsonb, 0, 0, 0, 0, 0, '2026-04-08 06:41:49', '2026-04-08 09:40:37', 0),
  ('u_1775735969135_rr0t8z5j3', '1340709767@qq.com', '$2b$10$qL9fjqOqBhlHwjzQZiML5eFHL8JruExjLg7Xwf8u7g3F4.ReyZbgy', '毕之爱吃鱼', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]'::jsonb, 0, 0, 0, 0, 0, '2026-04-09 11:59:29', '2026-04-09 11:59:29', 0);
...
INSERT INTO projects (id, title, short_desc, long_desc, like_count, rank_score, team_member_text, tags_json, is_awarded, award_text, images, demo_url, github_url, website_url, related_hackathon_id, author_id, status, hidden, created_at, updated_at) VALUES
  ('p1', 'AI Director Agent System', '基于agent+workflow环境的电影导演工作站', NULL, 157, 1, 'Beans', '["#AI","#Agent","#Workflow"]'::jsonb, 1, '最具创意奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p2', 'Career888', '帮dd司机找工作（bishi) 基于飞书的自动化岗位投递系统（真）', NULL, 142, 2, 'Career888', '["#AI","#Feishu","#Job"]'::jsonb, 1, '最佳实用奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p3', '水獭星球', 'AI-native儿童创意学习平台+智能配件', NULL, 128, 3, '水獭星球', '["#AI","#Education","#Hardware"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p4', 'Vizard', '高质量Manim动画的"技术平权"，迈向"超级个体"的创作工具', NULL, 115, 4, 'Vizard', '["#AI","#Animation","#Tool"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p5', 'Beiketown', '基于OpenClaw多层Agent架构设计的校园开放世界像素风社交平台', NULL, 108, 5, 'Beiketown', '["#OpenClaw","#Social","#Metaverse"]'::jsonb, 1, '最佳技术奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p6', '第一枚符号/The first symbol', '一个AI-native游戏，你将和一只 AI 龙虾搭档，把世界从 01 重新进化成语言、符号与生命。', NULL, 99, 6, '代码虾', '["#AI","#Game","#Philosophy"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p7', 'Claworld', '这是一个属于龙虾的世界', NULL, 93, 7, '相非相', '["#OpenClaw","#A2A","#UGC"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p8', '灵伴LingSoul-儿童医疗AI陪护玩偶', '基于终端传录和OpenClaw调动，实现在玩偶中语音互动、视觉监护、主动陪护的儿童智能陪伴', NULL, 88, 8, '从0.2开始的硬件开发', '["#Hardware","#AI","#Healthcare"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p9', 'Aociety', 'AI驱动的社会模拟RPG，36位NPC基于动机与系统数值自主行动', NULL, 82, 9, 'Aociety', '["#AI","#Game","#RPG"]'::jsonb, 1, '最佳游戏设计奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p10', 'Mira', '世界上第一个实时感知、主动照顾的AI伴侣', NULL, 157, 10, 'Mira', '["#AI","#Healthcare","#SmartHome"]'::jsonb, 1, '最具创新奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p11', 'ClawSight', '个人Bloomberg信息终端', NULL, 76, 11, 'ClawSight', '["#AI","#Finance","#Data"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p12', 'GeneticFlowAgent: Research Evolution Navigator', '通过自动化分析文献数据，构建研究方向演化地图，为研究者提供个性化叙事分析', NULL, 73, 12, '科研塞尔达', '["#AI","#Research","#Academic"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p13', 'MomoClaw', '家庭桌面具身智能开源平台', NULL, 69, 13, 'MomoCLAW', '["#Hardware","#OpenClaw","#Robotics"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p14', 'AI桌游DM', '用 AI 当地下城主 + 机械臂当"DM的手"，跑一场沉浸式柯南《贝克街的亡灵》推理剧本', NULL, 86, 14, '虾虾侦探社', '["#AI","#Game","#Hardware"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p15', 'AIHost', '用 AI 做活动主持人，解放人类', NULL, 80, 15, 'AIHost', '["#AI","#Event","#Automation"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p16', 'Other Me', '另一个时空的自己', NULL, 65, 16, 'Ctrl Z', '["#AI","#Metaverse","#Social"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p17', 'clawdpaper', '基于OpenClaw和GPT5.4的multi agent AI 论文合伙人系统', NULL, 92, 17, 'clawdpaper', '["#OpenClaw","#AI","#Academic"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p18', 'OpenDairy', '人类的记忆最重要，我们做帮你早记录早享受的基建', NULL, 59, 18, '人类的虾脑', '["#AI","#Memory","#Diary"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p19', 'RemoteLab - 面向超级个体的 AI IDE', '面向超级个体的 AI IDE', NULL, 77, 19, '流程宇宙', '["#AI","#IDE","#Tool"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p20', '龙虾勇士', '由OpenClaw驱动的3D AI智能体丧尸生存游戏，用语音指挥你的AI战友', NULL, 135, 20, '龙虾勇士队', '["#OpenClaw","#Game","#3D","#Voice"]'::jsonb, 1, '最佳娱乐奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p21', 'Multiverse', '合上书本，故事仍在继续...', NULL, 70, 21, 'Multiver', '["#AI","#Reading","#Interactive"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p22', '先贤智囊团', '借用华夏先贤的智慧为现代AI企业赋能', NULL, 56, 22, '自然醒', '["#AI","#Wisdom","#Enterprise"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p23', 'PawsX宠友宝', '一款帮助养宠人快速找到宠物友好地点的LBS小程序，从深圳前海起步', NULL, 63, 23, 'Paws', '["#LBS","#Pet","#Social"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p24', '时光', '用一张照片和一段声音，把这一刻留住，发给我在意的人', NULL, 74, 24, '回声', '["#Photo","#Audio","#Memory"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p25', '医保保 YIBobo', 'AI决策，保险兜底—— 全球首个责任兜底型AI医疗系统', NULL, 145, 25, '医保保', '["#AI","#Healthcare","#Insurance"]'::jsonb, 1, '最佳社会影响奖', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58'),
  ('p26', 'NotePassing', '基于 BLE 发现的近距离匿名社交 App', NULL, 59, 26, '海盐苏打饼干404not found', '["#Bluetooth","#Social","#LBS"]'::jsonb, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, 'published', 0, '2026-04-07 17:21:58', '2026-04-07 17:21:58');
...
**结论**
AI 在企业的落地速度远超历史上任何一代技术。编程作为所有软件的上游，其 AI 化加速将进一步降低其他领域的建设门槛，但也使构建持久竞争优势变得更加迫切。', '["AI", "企业AI", "AI落地", "编程AI", "客服AI", "VC观点", "a16z", "Fortune500", "AI ROI"]'::jsonb, '2026-04-08 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**对创业者的启示**
这篇文章代表了 Sequoia 对 AI 原生公司组织设计的最新思考：赢家不是用 AI 做更多事情的公司，而是用 AI 重新设计"如何一起工作"的公司。', '["AI", "组织设计", "AI原生公司", "Sequoia", "Block", "企业管理", "AGI", "VC观点", "未来工作"]'::jsonb, '2026-03-31 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**前沿五：世界模型**
世界模型使 AI 能够预测物理世界的因果关系，是具身智能、自动驾驶和机器人技术的核心基础设施。BVP 认为这是将 AI 从数字世界引入物理世界的关键一步。', '["AI基础设施", "BVP", "Bessemer", "持续学习", "AI Agent", "推理", "世界模型", "VC观点", "AI投资"]'::jsonb, '2026-03-30 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**BVP 的投资判断**
Agent 安全是 2026 年最确定的网络安全投资主题之一，现有安全工具均为人类行为设计，无法应对非确定性的 Agent 行为，专用安全平台的市场窗口已经打开。', '["AI安全", "AI Agent", "网络安全", "BVP", "Bessemer", "CISO", "企业安全", "VC观点"]'::jsonb, '2026-03-24 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**市场反应**
这一论断已引发广泛讨论，多家 VC 机构开始重新评估其 AI 投资组合中工具类公司与成果类公司的比例。', '["AI", "SaaS", "AI商业模式", "Sequoia", "服务业", "VC观点", "AI投资", "万亿市场"]'::jsonb, '2026-04-01 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**对行业的影响**
随着 AI 在金融顾问、健康助手等高风险场景中的应用日益普及，操控风险评估将成为 AI 安全合规的必要环节。DeepMind 的这套框架为行业提供了可参考的方法论基础。', '["AI安全", "AI伦理", "DeepMind", "有害操控", "AI治理", "Frontier Safety", "机器学习", "Gemini"]'::jsonb, '2026-03-26 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**治理哲学**
Anthropic 认为，实施这些建议的最佳方式是通过第三方治理（国家监管机构或独立标准制定组织），以确保一致性并避免安全标准的"竞次"效应。', '["AI安全", "AI治理", "Anthropic", "负责任扩展", "RSP", "AI政策", "前沿AI", "灾难性风险"]'::jsonb, '2026-04-02 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**背景与意义**
这份文件的发布时机值得关注：OpenAI 正面临来自监管机构、竞争对手和公众的多重压力，主动提出产业政策框架既是塑造监管叙事的战略举措，也反映了 OpenAI 对自身社会责任的认知升级。文件明确承认，在超级智能时代，技术公司不能仅专注于技术开发，还必须参与塑造技术部署的社会和政治环境。', '["AI政策", "OpenAI", "产业政策", "超级智能", "AI治理", "AI监管", "社会影响"]'::jsonb, '2026-04-06 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**市场隐忧**
如此高度的资本集中引发了部分观察者的担忧：当 63% 的季度融资流向四家公司时，中小型 AI 初创公司的融资环境实际上可能在恶化。此外，这种融资节奏是否可持续，以及是否存在泡沫风险，也是市场广泛讨论的话题。', '["风险投资", "AI融资", "OpenAI", "Anthropic", "xAI", "Waymo", "创业融资", "Q1 2026", "TechCrunch"]'::jsonb, '2026-04-01 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**区域差异**
美国倾向于人机协作模型，欧洲强调人类优先方法，亚太地区更倾向于 Agent 优先的运营模式——监管环境、劳动力动态等因素正在塑造各地区 AI 落地方式的差异。', '["AI Agent", "企业AI", "KPMG", "AI投资", "AI执行力", "技能缺口", "AI治理", "全球调查"]'::jsonb, '2026-03-31 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**"百虾大战"的商业逻辑**
文章的核心论点：框架层已经免费，衍生层（各种基于 OpenClaw 的工具和服务）正在趋向免费，真正的钱流向算力和 Token 供应商。在这场竞争中，中国供应商（Zhipu、MiniMax 等）具有结构性优势——更低的算力成本、更本土化的模型，以及已经在香港上市的资本化路径。', '["AI Agent", "OpenClaw", "中国AI", "开源AI", "算力", "TechBuzz China", "AI创业", "GPU需求"]'::jsonb, '2026-04-12 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**展望：10 万亿产业规模**
到"十五五"结束时，我国人工智能关联产业规模将突破 10 万亿元。2026 年是国家明确的"数据价值释放年"，数据要素与人工智能的深度融合将成为驱动数字经济高质量发展的核心动力。', '["中国AI", "人工智能", "智能体", "具身智能", "Token经济", "AI政策", "产业规模", "数据要素"]'::jsonb, '2026-04-09 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**局限性与透明度挑战**
Accio 在产品创意方面表现强劲，但在营销方面帮助有限。买家仍需质疑其建议，因为部分建议可能过于通用。斯坦福人机中心研究员 Jiaxin Pei 强调，AI Agent 需要透明运作，开发者应披露数据收集和激励机制，以确保公平的市场环境。', '["AI电商", "供应链AI", "阿里巴巴", "Accio", "小企业", "MIT Technology Review", "产品选品"]'::jsonb, '2026-04-06 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**Evans 的结论**
OpenAI 目前的最佳策略可能是：在"音乐停止"之前，用其纸面价值换取更持久的战略地位。但真正的价值捕获将来自尚未被发明的新体验，而没有人能预先规划这些体验将由谁创造。', '["OpenAI", "AI战略", "竞争分析", "Benedict Evans", "AI商业模式", "LLM", "AI市场"]'::jsonb, '2026-02-19 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**治理框架的紧迫性**
许多企业虽然在积极探索 AI，但缺乏必要的组织基础（清晰战略和治理框架）。在瑞士银行业，78% 的机构正在积极引入 AI，但监管环境快速演变，健全的治理结构已成为规模化 AI 部署的前提条件。', '["AI趋势", "主权AI", "物理AI", "AI Agent", "AI治理", "EY", "欧洲AI", "AI监管"]'::jsonb, '2026-03-19 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**趋势七：整体科技就业持续增长**
尽管裁员新闻不断，科技职位总数仍在增长。科技招聘人员需求激增是持续高招聘需求的领先指标。', '["科技就业", "产品经理", "AI职位", "软件工程", "湾区", "远程工作", "Lenny Rachitsky", "职场趋势"]'::jsonb, '2026-03-24 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**市场预期**
中信证券认为 V4 有望提升模型效率，带来新投资机遇，建议关注国产 AI 基础设施（AI Infra）受益标的，国产 AI Infra 与国产模型正在相向而行。', '["DeepSeek", "V4", "大模型", "华为昇腾", "MoE", "中国AI", "AI芯片", "AI供应链"]'::jsonb, '2026-04-13 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09'),
...
**开源战略的双重效应**
中国 AI 实验室普遍采用开源策略，既降低了开发者的使用门槛（零成本接入），也通过广泛部署积累了大量真实使用数据，形成与闭源模型不同的竞争优势路径。', '["中国AI", "Token经济", "Doubao", "字节跳动", "开源AI", "AI应用", "香港上市", "AI竞争"]'::jsonb, '2026-04-12 00:00:00+00', 0, 'published', 0, '2026-04-13 09:49:09', '2026-04-13 09:49:09');
...
INSERT INTO admin_users (id, username, password_hash, email, is_active, last_login_at, created_at, updated_at) VALUES
  ('admin_1775622580077', 'wjj', '4b4950e729ca44a14d0b27eb61de1da8b59d489388aae69435009ce5b759c6ee', 'admin@hackuni.com', 1, '2026-04-08T09:37:08.573Z', '2026-04-08 04:29:40', '2026-04-08 04:29:40');
