...
export default function HackathonsPage() {
  ...
  return (
    <main style={{ padding: 'var(--sp-8) var(--sp-6)', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 'var(--sp-6)', gap: 'var(--sp-4)', flexWrap: 'wrap' }}>
        <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-5)' }}>
        {filteredHackathons.map((hack) => {
          const posterStyle = getPosterSurfaceStyle(hack.id);
          ...
          <HackerCard key={hack.id} className="responsive-flex-col desktop-row" style={{ gap: 'var(--sp-5)' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ color: 'var(--text-main)', fontSize: 'var(--text-body)', margin: '0 0 var(--sp-4) 0', maxWidth: '100%' }}>
                {hack.short_desc}
              </p>
              ...
              <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 'var(--sp-3)', flexWrap: 'wrap' }}>
